...
void GameScene_2::Initialize() {
	...
	LoadDivGraph("Resources/No2.png", 8, 8, 1, 100, 100, image);

	explanation = LoadGraph("Resources/No2explanation.png");
...
void GameScene_2::Draw() {
	...
	DrawGraph(width[0] - radius, height[0] - radius, image[1], true);
	DrawGraph(width[1] - radius, height[1] - radius, image[3], true);
	DrawGraph(width[2] - radius, height[2] - radius, image[5], true);
	DrawGraph(width[3] - radius, height[3] - radius, image[7], true);
	DrawGraph(width[4] - radius, height[4] - radius, image[6], true);
	DrawGraph(width[5] - radius, height[5] - radius, image[4], true);
	DrawGraph(width[6] - radius, height[6] - radius, image[2], true);
	DrawGraph(width[7] - radius, height[7] - radius, image[0], true);
