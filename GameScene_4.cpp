...
void GameScene_4::Initialize() {
	...
	explanation = LoadGraph("Resources/No4explanation.png");

	nextScene = SceneManager::STAGE4;
...
#pragma endregion
	...
	{
		nextScene = SceneManager::STAGE5;
	}
}

void GameScene_4::Draw() {

	DrawGraph(360, 380, explanation, true);
	...
	DrawGraph(width[5] - radius, height[5] - radius, image[2], true);
	DrawGraph(width[6] - radius, height[6] - radius, image[4], true);
