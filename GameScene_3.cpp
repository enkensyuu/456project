...
void GameScene_3::Draw() {
	...
	DrawGraph(width[2] - radius, height[2] - radius, image[7], true);
	...
	DrawGraph(width[6] - radius, height[6] - radius, image[0], true);
	DrawGraph(width[7] - radius, height[7] - radius, image[1], true);
