...
void GameScene_5::Initialize() {
	...
	LoadDivGraph("Resources/No5.png", 8, 8, 1, 100, 100, image);

	explanation = LoadGraph("Resources/No5explanation.png");

	nextScene = SceneManager::STAGE5;

}

void GameScene_5::Update() {
